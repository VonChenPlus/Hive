...
SOURCES += $$P/externals/snappy/*.cpp
HEADERS += $$P/externals/snappy/*.h
INCLUDEPATH += $$P/externals/snappy

# udis86

SOURCES += $$P/externals/udis86/*.c
HEADERS += $$P/externals/udis86/*.h
INCLUDEPATH += $$P/externals/udis86
