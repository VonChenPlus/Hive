...
bool Background::init() {
    ...
    {
        { MATH::Vector3f(origin.x, origin.y, 0), color, GRAPH::Tex2F(getUIAtlas()[I_BG].u1, getUIAtlas()[I_BG].v2), },
        { MATH::Vector3f(origin.x, origin.y + visibleSize.height, 0), color, GRAPH::Tex2F(getUIAtlas()[I_BG].u1, getUIAtlas()[I_BG].v1), },
        { MATH::Vector3f(origin.x + visibleSize.width, origin.y, 0), color, GRAPH::Tex2F(getUIAtlas()[I_BG].u2, getUIAtlas()[I_BG].v2), },
        { MATH::Vector3f(origin.x + visibleSize.width, origin.y + visibleSize.height, 0), color, GRAPH::Tex2F(getUIAtlas()[I_BG].u2, getUIAtlas()[I_BG].v1), },
    };
...
void Background::update(float) {
    ...
    for (int i = 0; i < 100; i++) {
        ...
        int n = i & 3;
        float width = (float) getUIAtlas()[symbols[n]].w * 1.2f;
        float height = (float) getUIAtlas()[symbols[n]].h * 1.2f;
